 ...
 *
 * This class acts as a holder class for gson. Gson requires to know the type of the 
 * object it is converting to json format. ArrayList only allows to specify one generic
 * type. Using this class, gson will recognized all the 3 type of task correctly and are
 * able to convert them all to json format.
 */
